...
public class Arm extends SubsystemBase {
    ...
    private static GenericEntry kMinOutput = pidvals.add("akMinOutput", -1)
            .getEntry();
    private static GenericEntry akP = pidvals.add("a_akP", 20)
            .getEntry();
    private static GenericEntry akI = pidvals.add("a_akI", 0)
            .getEntry();
    private static GenericEntry akD = pidvals.add("a_akD", 10)
            .getEntry();
    ...
    public Arm() {
        ...
        medEncoder.setDistancePerPulse(1);
    ...
    public void setAngle(double angle) {
        ...
        System.out.println(anglePID.calculate(bigEncoder.get(), angle));
    }
